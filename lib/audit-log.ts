...
const AUDIT_ACTION_LABELS: Readonly<Record<string, string>> = {
  ...
  "doc.submit": "提交文档审核",
  "doc.withdraw": "作者撤回提交",
  "doc.start_review": "开始审核稿件",
  "doc.return": "退回文档修改",
  "doc.approve": "通过文档审核",
  "doc.cancel_approval": "取消文档定稿",
  "doc.comment.reply.create": "回复稿件批注",
  "open.content.read": "读取 Open API 正文",
  author_submit: "作者提交审核",
  author_withdraw: "作者撤回提交",
  editor_start_review: "编辑开始审核",
  ...
  "project.stage_plans.update": "更新项目阶段计划",
  ...
  "admin.param.si_metadata.create": "新建 SI 扩展配置",
  "admin.param.si_metadata.update": "更新 SI 扩展配置",
  "admin.param.workday_exceptions.replace": "更新工作日日历",
...
const AUDIT_FIELD_LABELS: Readonly<Record<string, string>> = {
  ...
  revisionId: "版本 ID",
  withdrawnSubmissionId: "撤回的提交版本 ID",
  reviewStartedAt: "本轮审核开始时间",
  ...
  siTypeCode: "SI 类型编码",
  siType: "SI 类型",
  creativeDifficultyId: "创作难度 ID",
  creativeDifficultyCode: "创作难度编码",
  creativeDifficulty: "创作难度",
  referenceBookTitle: "参考书籍标题",
  referenceBookUrl: "参考书籍链接",
  trope: "故事元素",
  freshTwist: "创新设定",
  coreSynopsis: "核心梗概",
  remarks: "备注",
